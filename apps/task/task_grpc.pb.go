...
func (c *serviceClient) CreateTask(ctx context.Context, in *CreateTaskRequst, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
	err := c.cc.Invoke(ctx, "/lxygwqf9527.cmdb.task.Service/CreateTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) QueryBook(ctx context.Context, in *QueryTaskRequest, opts ...grpc.CallOption) (*TaskSet, error) {
	out := new(TaskSet)
	err := c.cc.Invoke(ctx, "/lxygwqf9527.cmdb.task.Service/QueryBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) DescribeBook(ctx context.Context, in *DescribeTaskRequest, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
	err := c.cc.Invoke(ctx, "/lxygwqf9527.cmdb.task.Service/DescribeBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_CreateTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lxygwqf9527.cmdb.task.Service/CreateTask",
	}
...
func _Service_QueryBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lxygwqf9527.cmdb.task.Service/QueryBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_DescribeBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lxygwqf9527.cmdb.task.Service/DescribeBook",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "lxygwqf9527.cmdb.task.Service",
